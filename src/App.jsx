...
function App() {
  ...
  return (
    <div>
      ...
      {/* Pages */}
      {page === "home" && (
        <HomePage goCourses={goCourses} goStudentDashboard={goStudentDashboard} loggedUser={loggedUser} />
      )}
      {page === "courses" && loggedUser?.role === "student" && (
        <CoursesPage goStudentDashboard={goStudentDashboard} />
      )}
      {page === "student-dashboard" && loggedUser?.role === "student" && <StudentDashboard />}
